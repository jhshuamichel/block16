...
function logItemNames() {
  const callback = elem => console.log(elem. name);
  items.forEach(callback);
  //TODO DONE use the .forEach() method to log out the name of each item
}
...
console.log(findItemById);
 ...
 // TODO DONE: Use the .find() method to return the item who's id matches the passed in id
...
const capitalizedNames = capitalizeNames();
console.log(capitalizedNames);
  // TODO  DONE:  Use the .map() and possibly .slice() methods and return a new items array with the item names capitalized
...
function calculateTotalCartPrice() {
  ...
  33
  // TODO DONE: Loop through your cart and return the total price of all items in your cart
